...
- `manifest.json` 的 `style` 字段必须是以下枚举之一:`minimal`、`editorial`、`newsprint`、`bold`、`soft`、`pastel`、`glass`、`dark`、`cyber`、`technical`、`playful`、`data`、`retro`、`sketch`、`custom`(写其他值会导致 Design 页面加载失败);
- 只修改 `{{cwd}}/design/` 内的文件;
