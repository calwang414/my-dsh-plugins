    ...
    value === null && !error
      ...
      : React.createElement(React.Fragment, null,
          React.createElement(Group, { title: '桌宠设置' },
            ...
            React.createElement(Row, { title: '桌宠形象', desc: React.createElement(React.Fragment, null,
                '上传 VRM 1.0/0.x 模型;可用 ',
                React.createElement('a', { href: 'https://vroid.com/studio', target: '_blank', rel: 'noreferrer', style: { color: 'var(--dsw-alias-brand-primary)' } }, 'VRoid Studio'),
                ' 免费生成自己的形象;动画需标准人形骨骼,非人形模型仅静态展示' )},
